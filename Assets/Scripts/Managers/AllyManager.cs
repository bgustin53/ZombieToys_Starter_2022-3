...
public class AllyManager : MonoBehaviour
{
    ...
    [SerializeField] bool testAlly;             //Cause CanSummonAlly to always return true
    ...
    public bool CanSummonAlly()
    {
        ...
        return ((allyPoints >= allyCost) && !ally.gameObject.activeSelf) || testAlly;
    }
    ...
    public Ally SummonAlly()
    {
        ...
        {
            ally.transform.position = GameManager.Instance.EnemyTarget.position - Vector3.right * 5;
        }
